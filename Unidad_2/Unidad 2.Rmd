...
Aplicar los criterios de elección no probabilísticos al Ejemplo 1 para
determinar la acción por la que debería decidirse en cada caso.
...
+:------------------------------------------:+:----------:+:----------:+
| Acción (pedido) Estado de la naturaleza    | $a_1$ 100  | $a_2$ 200  |
| (demanda)                                  |            |            |
+--------------------------------------------+------------+------------+
| $\theta_1 = 100$                           | 2,000      | 0          |
+--------------------------------------------+------------+------------+
...
Se decide por "lo mejor de lo peor". El pago mínimo con la acción $a_1$
es \$1,500; mientras que el pago mínimo con la acció $a_2$ es \$0. Bajo
este criterio la mejor acción será:
...
Se elige "lo mejor de lo mejor". En el ejemplo 1, la elección se haría
entre el pago máximo de $a_1$ y el pago máximo de $a_2$:
...
**c) Criterio de Hurwicz - índice** $\alpha$ (Coeficientes optimistas -
pesimistas)

Se determina el valor esperado de cada acción con base en los "pesos"
que el decisor asigna a los pagos máximo y mínimo:
...
**d). Pesar minimax: Criterio de Savage (minimizar el arrepentimiento o
pérdida de oportunidad máxima)**
...
2. Determinar el valor máximo de cada acción
   ...
   De la matriz de pérdida de oportunidad se observa que el pesar
    máximo (pérdida de oportunidad) para: $a_1$: pedir 100 prendas, es
    \$4,500 $a_2$: pedir 200 prendas, es \$2,000

3. Elegir la acción que tiene el mínimo de los valores determinados en
    el punto 2.
...
Dentro de los criterios de decisión no probabilísticos no es común que
una mayoría coincida en una decisión. En condiciones de completa
incertidumbre, la elección del criterio que habrá de seguirse puede ser
crucial, por lo que debe dejarse al responsable de tomar la decisión. Su
elección será dictada por su propia actitud y por la política de la
organización.
